...
# Azure DevOps – UstawoŻerca (loader)
...
w projekcie UstawoŻerca:

**1. Pobierz pełny skill przez bash_tool:**
```bash
curl -sL "https://raw.githubusercontent.com/DTCodePL/Claude_Skills/main/Azure%20DevOps%20%E2%80%93%20UstawoZerca%20Task%20Creation%20Skill/SKILL.md" -o /tmp/ustawozerca_skill.md
cat /tmp/ustawozerca_skill.md
```
